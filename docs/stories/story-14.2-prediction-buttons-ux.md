...
### Unit Tests
- [ ] Test: Les boutons affichent "Plus haut" et "Plus bas"
- [ ] Test: La carte de référence est affichée au tour 2

### Visual Tests (MCP)
- [ ] Test: Boutons assez grands sur mobile (viewport 375px)
- [ ] Test: Style cohérent entre les 4 tours
